-- Chupinhado de: @giovannibassi (https://github.com/zanfranceschi/rinha-de-backend-2024-q1/blob/main/participantes/giovannibassi/sql/criartransacao.sql)
...
CREATE INDEX index_account_transaction ON transactions
(account_id ASC);
